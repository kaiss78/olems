...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        <table width="100%">
            <tr>
                <td align="center" style="height: 21px">
                    <asp:Label ID="baslik" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium"
                        ForeColor="#CC0000">SECTION MANAGEMENT
                    </asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:SqlDataSource ID="Section_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IS50220082G4_ConnectionString %>"
                        SelectCommand="SELECT [name], [capacity], [id] FROM [Section]" InsertCommand="INSERT INTO [Section] ([name],[capacity]) VALUES (@name,@capacity)"
                    ...
                    <asp:DetailsView ID="SectionDetailsView" runat="server" AllowPaging="True" AutoGenerateDeleteButton="True"
                        AutoGenerateInsertButton="True" AutoGenerateRows="False" CellPadding="4" DataSourceID="Section_SqlDataSource"
                        DefaultMode="Insert" ForeColor="#333333" Height="50px" Width="125px" Font-Names="Arial"
                        Font-Size="Small" GridLines="None" HeaderText="Create Section" OnItemInserted="SectionDetailsView_ItemInserted">
            ...
            <tr>
                <td>
                    <asp:LinkButton ID="lnkSearch" runat="server" Font-Bold="True" Font-Names="Arial"
                        Font-Size="Small" ForeColor="Black" OnClick="lnkSearch_Click" ToolTip="Type section name and press button to search">Search Section(s)</asp:LinkButton>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" SortExpression="name">
                                <EditItemTemplate>
                                    ...
                                    <asp:RangeValidator Display="Dynamic" ValidationGroup="GV" ID="reqValidator1" runat="server"
                                        ControlToValidate="txtSectionName" MaximumValue="255" MinimumValue="1" Type="Integer"
                                        ErrorMessage="Please enter Section name" Font-Names="Arial" Font-Size="Small"> Section name should be between 1-255
                                    </asp:RangeValidator>
                                </EditItemTemplate>
                                <ItemTemplate>
