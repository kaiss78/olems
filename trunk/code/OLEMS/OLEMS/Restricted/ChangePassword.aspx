<%@ Page Title="" Language="C#" MasterPageFile="~/OLEMS.Master" CodeBehind="ChangePassword.aspx.cs"
    Inherits="OLEMS.Restricted.ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ChangePassword ID="ChangePasswordOLEMS" runat="server" BackColor="#FFFBD6" BorderColor="#FFDFAD"
        ...
        CancelDestinationPageUrl="~/Springboard.aspx" 
        ContinueDestinationPageUrl="~/Springboard.aspx" 
        onchangedpassword="ChangePasswordOLEMS_ChangedPassword">
