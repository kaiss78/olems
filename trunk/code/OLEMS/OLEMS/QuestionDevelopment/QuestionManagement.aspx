<%@ Page Language="C#" MasterPageFile="~/OLEMS.Master" AutoEventWireup="true" CodeBehind="QuestionManagement.aspx.cs"
    Inherits="OLEMS.QuestionDevelopment.QuestionManagement" Title="Question Management" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="Question_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IS50220082G4_ConnectionString %>"
                ...
                <asp:SqlDataSource ID="Topic_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IS50220082G4_ConnectionString %>"
                    SelectCommand="SELECT [id], [name] FROM [Topic] order by 2"></asp:SqlDataSource>
                <asp:SqlDataSource ID="QuestionType_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IS50220082G4_ConnectionString %>"
                    SelectCommand="SELECT [id], [name] FROM [QuestionType] order by 2"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:DetailsView ID="QuestionDetailsView" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    Font-Names="Arial" Font-Size="Small" OnItemInserted="QuestionDetailsView_ItemInserted"
                    OnItemInserting="QuestionDetailsView_ItemInserting" OnItemCommand="QuestionDetailsView_ItemCommand">
                        ...
                        <asp:TemplateField HeaderText="Topic" SortExpression="topicId">
                            <InsertItemTemplate>
                                <asp:DropDownList ID="topicDropDownList" runat="server" DataSourceID="Topic_SqlDataSource"
                                    AppendDataBoundItems="true" SelectedValue='<%#Bind("topicId") %>' DataMember="DefaultView"
                        ...
                        <asp:TemplateField HeaderText="Body" SortExpression="body">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqValidatorBody" runat="server"
                                    ErrorMessage="Please enter body of the question" ControlToValidate="txtBody"
                        ...
                        <asp:TemplateField HeaderText="Point" SortExpression="point">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqValidatorPoint" runat="server"
                                    ErrorMessage="Please enter point" ControlToValidate="txtPoint" Font-Names="Arial"
                                    Font-Size="Small">
                                </asp:RequiredFieldValidator>
                        ...
                        <asp:TemplateField HeaderText="Type" SortExpression="questionTypeId">
                            <InsertItemTemplate>
                                <asp:DropDownList ID="qTypeDropDownList" runat="server" DataSourceID="QuestionType_SqlDataSource"
                                    AppendDataBoundItems="true" SelectedValue='<%#Bind("questionTypeId") %>' DataMember="DefaultView"
                                    DataTextField="name" DataValueField="id">
                                </asp:DropDownList>
                            </InsertItemTemplate>
                        </asp:TemplateField>
        ...
        <tr>
            <td>
                <asp:GridView ID="QuestionGridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:CommandField ShowSelectButton="True" ValidationGroup="GV" SelectText="AnswerSet">
                        ...
                        <asp:TemplateField HeaderText="Topic" SortExpression="topicId">
                            ...
                            <ItemTemplate>
                                <asp:DropDownList ID="topicDropDownList2" runat="server" DataSourceID="Topic_SqlDataSource"
                                    AppendDataBoundItems="true" SelectedValue='<%#Bind("topicId") %>' DataMember="DefaultView"
                                    Enabled="False" DataTextField="name" DataValueField="id">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Body" SortExpression="body">
                        ...
                        <asp:TemplateField HeaderText="Point" SortExpression="point">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPoint" runat="server" Text='<%# Bind("point") %>'></asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqValidatorGVPoint" ValidationGroup="GV"
                                    runat="server" ErrorMessage="Please enter point" ControlToValidate="txtPoint"
                                    Font-Names="Arial" Font-Size="Small">
                                </asp:RequiredFieldValidator>
                                <asp:RangeValidator Display="Dynamic" ID="valGVPoint" runat="server" ValidationGroup="GV"
                                    ControlToValidate="txtPoint" MaximumValue="100" MinimumValue="1" Type="Integer"
                                    Font-Names="Arial" Font-Size="Small"> Point should be between 1-100
                                </asp:RangeValidator>
                            </EditItemTemplate>
                            <ItemTemplate>
