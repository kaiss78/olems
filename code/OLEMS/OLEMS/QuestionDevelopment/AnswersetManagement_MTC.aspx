<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnswersetManagement_MTC.aspx.cs" Inherits="OLEMS.QuestionDevelopment.AnswersetManagement_MTC" %>
...
<head id="Head1" runat="server">
    <title>AnswerSet (Matching Choice Questions)</title>
</head>
<body>
        ...
        <tr>
            <td align="center" style="height: 21px">
                <asp:Label ID="baslik" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium"
                    ForeColor="#CC0000">MATCHING CHOICE QUESTION ANSWERSET 
                </asp:Label>
            </td>
        </tr>
        <tr>
            <td>    
                <asp:SqlDataSource ID="ChoicesSqlDataSource" runat="server" 
                    ...
                    InsertCommand="INSERT INTO [Choice] (questionId,body,truthValue) VALUES (@questionId,@body,@truthValue)" 
        ...
        <tr>
            <td>            
                <asp:DetailsView ID="ChoicesDetailsView" runat="server" CellPadding="4" DataKeyNames="id" 
                    ...
                    Height="50px" Width="557px" AutoGenerateInsertButton="True" 
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Choice Matching Value" SortExpression="truthValue">                      
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtTruthValue" runat="server" Text='<%# Bind("truthValue") %>'></asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqValidatorMV" runat="server" ErrorMessage="Please enter matching value"
                                    ControlToValidate="txtTruthValue" Font-Names="Arial" Font-Size="Small">
                                </asp:RequiredFieldValidator>
                            </InsertItemTemplate>                           
            ...
            <td>                
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Choice Matching Value" SortExpression="truthValue">
                            <EditItemTemplate>                               
                                <asp:TextBox ID="txtTruthValueGV" runat="server" Text='<%# Bind("truthValue") %>'></asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" ID="reqValidator" runat="server" 
                                    ErrorMessage="Please enter matching value"  ValidationGroup="GV" 
                                    ControlToValidate="txtTruthValueGV" Font-Names="Arial" Font-Size="Small">
                                </asp:RequiredFieldValidator>
                            </EditItemTemplate>
                            <ItemTemplate>
