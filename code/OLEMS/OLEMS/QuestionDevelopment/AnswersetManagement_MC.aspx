<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnswersetManagement_MC.aspx.cs" Inherits="OLEMS.QuestionDevelopment.AnswersetManagement_MC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>AnswerSet (Multiple Choice Questions)</title>
</head>
<body>
        ...
        <tr>
            <td align="center" style="height: 21px">
                <asp:Label ID="baslik" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium"
                    ForeColor="#CC0000">MULTIPLE CHOICE QUESTION ANSWERSET 
                </asp:Label>
            </td>
        </tr>
        <tr>
